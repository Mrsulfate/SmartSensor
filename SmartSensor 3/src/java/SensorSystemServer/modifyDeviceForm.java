 ...
 */
@Path("device-management/modify")
public class modifyDeviceForm {
    
    @GET
    @Produces(MediaType.TEXT_HTML)
    public String modifyDeviceForm() {
        ...
        StringBuilder builder = new StringBuilder();
            ...
            builder.append("<body>"
                    ...
                    + " <div>  <font color=\"blue\">Device Name   </font>:<input name=\"device_name\" type=\"text\" style=\"float:right;margin-top:10px;\"/>  \n"
                    + " <div> <br/>  <button type =\"submit\">Accept Modifications</button>  </form> </div>\n"
                    + " </div> "
