 ...
 */
@Path("device-management/delete/success")
public class deleteDevice {
    
    
    public static SensorSystemInterface soapPort;
            
    public deleteDevice() throws MalformedURLException {   
    ...
    public String deleteDevice(@FormParam("device_id") int device_id) {
     ...
     + soapPort.delete_Device(Credentials.token, device_id)
