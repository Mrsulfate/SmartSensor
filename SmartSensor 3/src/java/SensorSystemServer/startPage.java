...
public class startPage {
    ...
    public String startPage() throws Exception {
        ...
        builder.append(" <form action=\"device-management\" method=\"get\"> "
                ...
                + "  <form action=\"device-management/delete\" method=\"get\" \">"
                + " <div>    <button type =\"submit\">Delete Device</button>  </form> <br/> </div>"
                ...
                + " <form action=\"sensor-management/delete\" method=\"get\"  \">"
                + " <div> <button type =\"submit\">Delete Sensor</button>  </form> <br/>  </div>\n"
                
                //// OTHERS ////
                + "  <form action=\"newLayout\" method=\"get\">"
